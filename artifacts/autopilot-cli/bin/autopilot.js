...
program
  ...
  .alias('pair')
  .alias('web')
  .description('Connect local machine CLI to Autopilot Web Dashboard (real-time stream)')
  .option('--api <url>', 'Custom API URL for the web bridge')
  .option('--web-url <url>', 'Custom Web Dashboard URL')
  .option('--start', 'Start watcher engine immediately upon connecting')
  .option('--no-open', 'Do not automatically open the browser')
  .option('--disconnect', 'Clear and disconnect active web bridge session')
  .action((code, options) => connectCommand(code, options));
