...
- `--ai`: Enable AI commit message generation (requires an OpenRouter API key).
...
5.  If you are starting from an empty folder, it can create the git repository for you first.
...
Starts the foreground file watcher.
...
**What it does:**
*   Runs a foreground watcher process in your terminal.
