...
First, let's create a new directory and initialize a git repository. Autopilot now offers to do this for you during `autopilot init`, but it is helpful to know what is happening under the hood.
